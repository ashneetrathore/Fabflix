 ...
 */
@WebFilter(filterName = "DashboardLoginFilter", urlPatterns = "/dashboard/*")
public class DashboardLoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (httpRequest.getSession().getAttribute("employee") == null) {
            httpResponse.sendRedirect("dlogin.html");
        } else {
            chain.doFilter(request, response);
        }
    }
    ...
    public void init(FilterConfig fConfig) {
        ...
        allowedURIs.add("dlogin.html");
        allowedURIs.add("dlogin.js");
        allowedURIs.add("/dashboard/dlogin");
